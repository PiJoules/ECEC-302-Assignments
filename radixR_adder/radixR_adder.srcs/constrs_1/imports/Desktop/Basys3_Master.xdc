...
#set_property PACKAGE_PIN R3 [get_ports {y[11]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[11]}]
#set_property PACKAGE_PIN W2 [get_ports {y[12]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[12]}]
#set_property PACKAGE_PIN U1 [get_ports {y[13]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[13]}]
#set_property PACKAGE_PIN T1 [get_ports {y[14]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {y[14]}]
#set_property PACKAGE_PIN R2 [get_ports {y[15]}]					
